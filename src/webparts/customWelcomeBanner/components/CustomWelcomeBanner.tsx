  ...
  return (
    ...
    {props.layout === "inline" ? (
      <Stack horizontal verticalAlign={props.verticalAlign as any} horizontalAlign={props.horizontalAlign as any}  style={{background: props.bckGrndColor, height: props.height, padding: props.bannerPaddingValue, width: widthPercentage}}>
        ...
        <StackItem>{props.btnType === 'Primary' && <PrimaryButton styles={{root: {backgroundColor: props.color, fontSize: props.buttonTextSize}, rootHovered: {backgroundColor: props.color}}}>{props.btnText}</PrimaryButton>}</StackItem>
